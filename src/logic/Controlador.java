...
public class Controlador {
    ...
    public static Almacen almacen = new Almacen(1, "Carulla-116", 2365554, "Autonorte-116");

    private static Producto producto = new Producto(1, "bonyurt oreo 250g", 2800, 2000, 14, subCategoria, almacen);
    public static LinkedAVL<Producto> ArbolProductosTotales = new LinkedAVL<>(producto);

    public static Empleado empleado = new Empleado(1, almacen, 1, "Juan", "Vargas", "11 jun 1999",
            "31350", "1234", "administrador");

    public static LinkedAVL<Empleado> ArbolEmpleadosTotales = new LinkedAVL<>(empleado);

    public static Proveedor proveedor = new Proveedor(1, "Alpina");
    public static LinkedAVL<Proveedor> ArbolProveedoresTotales = new LinkedAVL<>(proveedor);
    ...
    public static HashTable<Pedido> PedidosTotalesHash = new HashTable();
    public static HashTable.HashMap MapaPedidos = Controlador.PedidosTotalesHash.new HashMap();
